...
parser.add_argument('--expand', type=str, default=None, help='Add layers to model throughout training.',
...
parser.add_argument('--widen', type=str, default=None, help='widen the model throughout training.',
                    choices=["reinit", "duplicate"])
parser.add_argument("--widen_dict", action=StoreDictKeyPair, metavar="KEY1=VAL1,KEY2=VAL2...", default={},
                    help='Pass a dictionary formatted "KEYi=VALi,KEYj=VALj..."'
